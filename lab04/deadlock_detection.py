...
# เกณฑ์เวลาในการตรวจจับ (Timeout ในหน่วยวินาที)
TIMEOUT = 2.0 
...
def train_model_a():
    ...
    # DEADLOCK DETECTION: รอไม่เกินเวลา TIMEOUT วินาที
    ...
    if not acquired:
        ...
        gpu_0_lock.release() # Rollback / ดึงทรัพยากรคืน (Preempt resource)
        return
...
def train_model_b():
    ...
    # Model B จะติดค้างตรงนี้ แต่จะได้รับการช่วยเหลือเมื่อ Model A ยอมปล่อยทรัพยากร
    gpu_0_lock.acquire()
